...
export function flashBlockOutline(element: HTMLElement, durationMs = 400): void {
  element.animate(
    [
      { outlineStyle: 'solid', outlineWidth: '2px', outlineColor: 'rgba(255,77,0,0)', outlineOffset: '0px' },
      { outlineStyle: 'solid', outlineWidth: '2px', outlineColor: 'rgba(255,77,0,0.7)', outlineOffset: '-8px' },
      { outlineStyle: 'solid', outlineWidth: '2px', outlineColor: 'rgba(255,77,0,0)', outlineOffset: '0px' },
    ],
